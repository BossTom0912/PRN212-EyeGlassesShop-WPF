...
using EyeGlasses_Store.Models;
using Microsoft.EntityFrameworkCore;

namespace EyeGlasses_Store.Data;

public partial class OpticShopDbContext : DbContext
{
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=PRN_PROJECT;Username=postgres;Password=12345");
        }
    }
    ...
    {
        modelBuilder
            .HasPostgresEnum("log_action", new[] { "REGISTER", "LOGIN", "LOCK_ACCOUNT", "UNLOCK_ACCOUNT", "CHANGE_ROLE", "CREATE_PRODUCT", "UPDATE_PRODUCT", "DELETE_PRODUCT", "APPROVE_ORDER", "UPDATE_ORDER_STATUS" })
            .HasPostgresEnum("order_status", new[] { "PENDING", "APPROVED", "PREPARING", "SHIPPING", "COMPLETED", "CANCELLED" })
            .HasPostgresEnum("payment_method", new[] { "COD" });
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CartId, e.ProductVariantId }, "uq_cart_variant").IsUnique();
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasIndex(e => e.ApprovedByOwnerId, "idx_orders_approved_by_owner_id");
            ...
            entity.Property(e => e.PaymentMethod)
                .HasMaxLength(30)
                .HasDefaultValueSql("'COD'::payment_method")
